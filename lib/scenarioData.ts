...
export interface Scenario {
  ...
  `function login(username, password) {
    ...
    },
    {
      ...
      description: "O pagină de căutare afișează termenul căutat de utilizator...", // Prescurtat
      difficulty: "Ușor",
  ...
  app.get('/search', (req, res) => {
    ...
    res.send(\`<h1>Rezultate pentru: ${searchTerm}</h1> ...restul paginii...\`);
  });`,
      secureCode:
  `// Server-side code (e.g., Node.js/Express)
  ...
  app.get('/search', (req, res) => {
    ...
    res.send(\`<h1>Rezultate pentru: ${escapedTerm}</h1> ...restul paginii...\`);
  });`,
      hints: [
